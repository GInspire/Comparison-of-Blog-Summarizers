...
public class Main2Activity extends AppCompatActivity {
    ...
    private DataPoint[] generateDataLsa() {
        ...
        Double yarr[]={0.7776d,0.2741d,0.1654d,0.2335d,0.1907d};
    ...
    private DataPoint[] generateDataKLSum() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.6924d,0.1684d,0.0250d,0.0500d,0.0333d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataTextRank() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.8106d,0.3899d,0.2321d,0.3371d,0.2628d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataLexRank() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.7574d,0.3435d,0.2119d,0.2754d,0.2323d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataLuhn() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.7963d,0.3800d,0.2273d,0.3021d,0.2548d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);

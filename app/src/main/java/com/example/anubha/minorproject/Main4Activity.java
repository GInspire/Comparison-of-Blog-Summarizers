...
public class Main4Activity extends AppCompatActivity {
    ...
    private DataPoint[] generateDataLsa() {
        ...
        Double yarr[]={0.7011d,0.3021d,0.4383d,0.2838d,0.3179d};
    ...
    private DataPoint[] generateDataKLSum() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.6015d,0.4001d,0.5641d,0.3590d,0.4542d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataTextRank() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.7888d,0.4332d,0.6974d,0.3971d,0.5026d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataLexRank() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.7011d,0.3264d,0.3211d,0.2971d,0.2081d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
    ...
    private DataPoint[] generateDataLuhn() {
        ...
        DataPoint[] values = new DataPoint[count];
        Double xarr[]={1d,2d,3d,4d,5d};
        Double yarr[]={0.7642d,0.3687d,0.4516d,0.2984d,0.3297d};
        for (int i=0; i<count; i++) {
            double x = xarr[i];
            double y = yarr[i];
            DataPoint v = new DataPoint(x, y);
